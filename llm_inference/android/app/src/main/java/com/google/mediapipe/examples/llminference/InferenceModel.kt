...
//            inferenceModel.generateResponseAsync(systemPrompt)
//            inferenceModel.partialResults.collect { (partialResult, done) ->
//                if (done) {
//                    _uiState.value.addMessage(partialResult, MODEL_PREFIX)
//                }
//            }
//        }
//    }
    ...
    companion object {
        ...
        private const val MODEL_PATH = "/data/local/tmp/hmm.bin"
